...
object FakeApiServiceGenerator {
    ...
    val FAKE_USERS = mutableListOf(
        ...
        User("005", "Francis", "https://robohash.org/6.png?size=300x300"),
        User("006", "George", "https://robohash.org/5.png?size=300x300"),
        User("007", "Louis", "https://robohash.org/7.png?size=300x300"),
        User("008", "Mateo", "https://robohash.org/10.png?size=300x300"),
        User("009", "April", "https://robohash.org/8.png?size=300x300"),
        User("010", "Louise", "https://robohash.org/11.png?size=300x300"),
